...
--========================================================================--
-- [5] FAST LOOT (Optimized with spatial lookup)
--========================================================================--
...
local function enableLoot()
    ...
    lootConn = UIS.InputBegan:Connect(function(input, gpe)
        ...
        -- Use spatial query instead of scanning whole workspace
...
--========================================================================--
-- [8] FPS BOOST (Optimized - No periodic rescan)
--========================================================================--
local fpsOn              = false
...
local function enableFPSBoost()
    ...
    -- One-time scan in a coroutine (does not block UI)
    task.spawn(function()
        pcall(scanAndRemoveEffects)
    end)

    -- Only handle new descendants (no periodic rescan = no lag)
...
--========================================================================--
-- [10] RETURN HOME BUTTON (Fixed connection inside create)
--========================================================================--
...
local function createReturnHomeButton()
    ...
    -- Direct click connection (fixed)
    returnBtnConn = wrap.MouseButton1Click:Connect(function()
        beginReturnHome()
    end)
...
MainTab:Toggle({
    ...
    Desc = "Hides all body parts to prevent ragdoll",
    Icon = "shield-check",
    Type = "Checkbox",
    Value = false,
    Callback = function(state)
...
MainTab:Paragraph({
    ...
    Desc = "Speed & Anti-Ragdoll share a single drive system using a local fake Humanoid.\n"
        .. "Anti-Ragdoll hides all body parts to prevent ragdoll.\n"
        .. "Fast Loot sets HoldDuration to 0 and auto-fires the nearest prompt with Key E.\n"
        .. "Hitbox Expand enlarges other players' hitboxes.\n"
        .. "Return Home uses the floating button or the tab button.",
    Icon = "info",
})
...
VisualTab:Paragraph({
    ...
    Desc = "Sets QualityLevel to minimum, FramerateCap 240.\n"
        ...
        .. "Removes Particle / Trail / Beam / Smoke / Fire / Sparkles / Explosion.\n"
        .. "Turns off all Point / Spot / Surface lights.\n"
        .. "Reduces water detail and MeshPart render fidelity.",
    Icon = "info",
})
